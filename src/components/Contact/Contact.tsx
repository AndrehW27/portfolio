  ...
  return (
    <>
      <section id="contact" className="relative white:bg-white-bg h-dvh w-dvw flex flex-col items-center justify-start text-text white:text-text-dark font-bold bord-red-500">
        ...
        <textarea data-aos="flip-up" data-aos-offset="200" className='text-xs sm:text-xl sm:p-5 border border-accent white:border-light-blue px-3 py-1 rounded-md mt-4 font-normal w-60 sm:w-140 h-30 sm:h-60' name="" id="message" placeholder='E-mail me here' value={message} onChange={(e) => setMessage(e.target.value)}></textarea>
        ...
        <div data-aos="zoom-in" data-aos-offset="0" className='absolute bottom-40 sm:bottom-60 w-40 sm:w-70 h-fit flex items-center justify-evenly'>
          ...
          <a href="https://github.com/AndrehW27" target="_blank" rel="noopener noreferrer">
            <div className='white: border border-dark-gray w-9 h-9 sm:w-15 sm:h-15 p-2 rounded-md shadow-[0_0_10px_#e8e9e9] white:shadow-[0_0_10px_#1f1f1f] flex items-center justify-center'>
              <i className="text-3xl sm:text-4xl mr-4text-accent devicon-github-original"></i>
            </div>
          </a>
