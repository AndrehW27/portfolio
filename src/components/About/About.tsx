    ...
    <>
      <section id="about" className='bg-background font-bold white:bg-white-bg text-text white:text-text-dark border-accent white:border-light-blue w-dvw flex flex-col items-center justify-start pb-20'>
        ...
        <div className='relative flex justify-center items-end gap-3 h-dvh w-dvw border-red-500 text-xs sm:text-base'>
          ...
          <h1 data-aos="fade-in" className='absolute top-26 text-text white:text-dark-gray text-2xl sm:text-2xl font-bold'>{t("about.aboutme")}</h1>


          <div data-aos="fade-left" className='pl-6 pr-2 flex flex-col justify-start items-start h-130 w-60 sm:w-160 border-blue-500'>
            ...
            <div>
              ...
              {/* <img data-aos="fade-right" data-aos-offset="0" className='absolute bottom-0 border-3 border-blue-500 w-[80dvw] image-blur-edges ml-10 sm:ml-60' src={perfil} alt="A cool image" /> */}
            </div>
          </div>

          <div data-aos="fade-right" className='pl-2 pr-6 h-110 sm:h-100 w-60 sm:w-100 border-accent white:text-dark-gray'>
          ...
          <div data-aos="fade-right" data-aos-offset="0" className='absolute bottom-0 left-10 border-blue-500 w-[50dvw] h-fit rounded-full z-999'>
            <img className='' src={perfil} alt="A cool image" />
          </div>

        </div>

        <h1 data-aos="fade-in" className='white:text-dark-gray mt-30 text-2xl sm:text-2xl font-bold'>{t("about.journey")}</h1>

        <div className='white:text-dark-gray  border-yellow-300 text-xs w-[70vw] flex items-center justify-center mt-20'>
          ...
          <div className='w-35 sm:text-base sm:w-100 border-red-500 flex flex-col justify-start items-center'>
            <div className='w-40 sm:w-100 h-50 border-blue-500 flex justify-end items-start'>
              <div>
                <img data-aos="fade-left" className=' h-9 w-9 sm:h-15 sm:w-15  p-2 rounded-md shadow-[0_0_10px_#3594d2] white:shadow-[0_0_10px_#3594d2] transition duration-300 ease-in-out' src={logic} />
              </div>
            </div>
