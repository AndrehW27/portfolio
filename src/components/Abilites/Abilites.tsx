        ...
        <div className="flex flex-col sm:flex-row items-center items:start justify-center gap-6 sm:gap-10 text-sx sm:text-xl w-[100dvw] white:text-dark-gray mt-20 sm:mt-30 sm:mb-20">
          ...
          <div className="box shadow-[0_0_15px_#7C3AED] white:shadow-[0_0_10px_#6594fc]   p-6 sm:p-8 w-[90dvw] h-fit sm:w-130 sm:min-h-100 rounded-3xl bg-background white:bg-text  bg-center bg-cover bg-no-repeat image-blured hover:bg-accent hover:border-text transition duration-300 ease-in-out">
            ...
            <div className="relative z-10 flex flex-col items-start justify-start gap-3 sm:gap-6">
              ...
              <ul className="font-bold list-disc ml-6">
                <li className="mb-2">{t("abilities.tools.item1")} <span className="rounded-full white:text-text px-2  text-[12px] sm:text-[18px]  bg-[#00a1e0]">react</span>  <span className="rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   bg-red-700">angular</span>  <span className="bg-blue-700 rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">lwc</span></li>
                <li className="mb-2">{t("abilities.tools.item2")} <span className="bg-green-500 rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">node</span>  <span className="bg-red-700 rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">java</span>  <span className="bg-blue-500 rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">apex</span></li>
                <li className="mb-2">{t("abilities.tools.item3")} <span className="bg-green-500 rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">mongo</span>  <span className="bg-blue-400 rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">postgre</span>  <span className="bg-blue-500  rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">soql</span></li>
                <li className="mb-2">{t("abilities.tools.item4")} <span className="bg-gray-700  rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">github</span>  <span className="bg-gray-900  rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">vercel</span>  <span className="bg-green-400  rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">netlify</span></li>
                <li className="">{t("abilities.tools.item5")} <span className="bg-orange-500  rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">aws</span>  <span className="bg-blue-700  rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">docker</span>  <span className="bg-purple-700  rounded-full white:text-text px-2  text-[12px] sm:text-[18px]   ">insomnia</span></li>
              </ul>
            </div>
