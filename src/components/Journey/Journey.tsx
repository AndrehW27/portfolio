                            ...
                            <div className=' w-full border-red-500 flex'>
                                ...
                                <div className='pl-4 w-[86%] h-40 border-yellow-500 flex flex-col justify-start items-start'>
                                    ...
                                    <div className='mt-2 flex gap-3'>
                                        ...
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="200" data-aos-offset="300" className='icons hover:bg-[#2f94f6] bg-background white:bg-background w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#2f94f6] white:shadow-[0_0_10px_#2f94f6] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/amazonwebservices/amazonwebservices-plain-wordmark.svg" />
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="400" data-aos-offset="300" className='icons hover:bg-[#2f94f6] bg-background w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#2f94f6] white:shadow-[0_0_10px_#2f94f6] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/insomnia/insomnia-original.svg" />
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="600" data-aos-offset="300" loading="lazy" className='icons hover:bg-[#82aee3] bg-text w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#82aee3] white:shadow-[0_0_10px_#82aee3] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/splunk/splunk-original-wordmark.svg" />
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="800" data-aos-offset="300" className='icons hover:bg-[#2f94f6] bg-background white:bg-background w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#2f94f6] white:shadow-[0_0_10px_#2f94f6] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/typescript/typescript-original.svg" />
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="1000" data-aos-offset="300" className='icons hover:bg-[#2f94f6] bg-background white:bg-background w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#2f94f6] white:shadow-[0_0_10px_#2f94f6] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className=' w-full border-red-500 flex'>
                                ...
                                <div className='pl-4 w-[86%] h-40 border-yellow-500 flex flex-col justify-start items-start'>
                                    ...
                                    <div className='mt-2 flex gap-3'>
                                        ...
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="200" data-aos-offset="300" className='icons hover:bg-[#2f94f6] bg-text w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#2f94f6] white:shadow-[0_0_10px_#2f94f6] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/express/express-original-wordmark.svg" />
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="400" data-aos-offset="300" className='icons hover:bg-[#2f94f6] bg-background w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#2f94f6] white:shadow-[0_0_10px_#2f94f6] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-plain-wordmark.svg" />
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="600" data-aos-offset="300" loading="lazy" className='icons hover:bg-[#82aee3] bg-background white:bg-background w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#82aee3] white:shadow-[0_0_10px_#82aee3] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mongodb/mongodb-plain-wordmark.svg" />
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="800" data-aos-offset="300" className='icons hover:bg-[#2f94f6] bg-background white:bg-background w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#2f94f6] white:shadow-[0_0_10px_#2f94f6] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/docker/docker-original.svg" />
                                        <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="1000" data-aos-offset="300" className='icons hover:bg-[#2f94f6] bg-text w-9 h-9 sm:w-20 sm:h-20 shadow-[0_0_10px_#2f94f6] white:shadow-[0_0_10px_#2f94f6] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-line-wordmark.svg" />
                                    </div>
                                </div>
                            </div>
                        </div>
