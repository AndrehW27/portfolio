          ...
          <div ref={ContentFade} className="border-red-500 relative z-10 w-dvw sm:w-fit h-svh flex flex-col items-start justify-start border-accent text-white white:text-dark-gray font-bold">
            ...
            <div className='sm:border border-accent sm:mb-10 white:border-light-blue sm:bg-black/30 white:sm:bg-white/30 rounded-3xl ml-10 sm:ml-0 sm:flex sm:items-start sm:justify-start sm:mt-35'
              ...
              <div className="card-home hidden sm:flex border-accent">
                <div data-aos="fade-in" data-aos-duration="2000" data-aos-offset="0" data-aos-delay="2000" className="relative w-100 sm:w-230 h-85 sm:h-[60svh] clip-hex bg-gradient-to-tr from-background from-[20%] via-surface via-[50%] to-accent to-[120%] white:bg-gradient-to-tr white:from-background white:from-[15%] white:via-light-blue white:via-[50%] white:to-text white:to-[100%] justify-end items-center">
                  <img data-aos="fade-right" data-aos-duration="2000" data-aos-offset="-500" data-aos-delay="2800" className="absolute rounded-3xl bottom-0 left-10 h-[60svh]" src={bg} />
            ...
            <div className='sm:hidden text-sm mt-5 w-80 ml-10 '>
              ...
              <div className='flex gap-4 mt-6'>
                <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="800" data-aos-offset="-500" loading="lazy" className='rounded-full p-2 white:bg-background hover:bg-[#61dafb] bg-background w-9 h-9 sm:w-15 sm:h-15 shadow-[0_0_10px_#61dafb] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg" />
                <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="1200" data-aos-offset="-500" loading="lazy" className='rounded-full p-2 white:bg-background hover:bg-[#ea23a4] bg-background w-9 h-9 sm:w-15 sm:h-15 shadow-[0_0_10px_#ea23a4] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/angular/angular-original.svg" />
                <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="1600" data-aos-offset="-500" loading="lazy" className='rounded-full p-2 white:bg-background hover:bg-[#5fa04e] bg-background w-9 h-9 sm:w-15 sm:h-15 shadow-[0_0_10px_#5fa04e] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-plain-wordmark.svg" />
                <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="2000" data-aos-offset="-500" loading="lazy" className='rounded-full p-2 white:bg-background hover:bg-[#ff9900] bg-background w-9 h-9 sm:w-15 sm:h-15 shadow-[0_0_10px_#ff9900] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/amazonwebservices/amazonwebservices-plain-wordmark.svg" />
                <img data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="2400" data-aos-offset="-500" loading="lazy" className='rounded-full p-2 white:bg-background hover:bg-[#00a1e0] bg-background w-9 h-9 sm:w-15 sm:h-15 shadow-[0_0_10px_#00a1e0] transition' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/salesforce/salesforce-original.svg" />
              </div>
              ...
              <div data-aos="fade-in" data-aos-duration="2000" data-aos-offset="0" data-aos-delay="2000" className="flex w-110 sm:w-190 h-70 sm:h-120 clip-hex justify-end items-center">
                ...
                <div className='absolute top-0 right-0 w-90 h-full bg-[linear-gradient(to_left,#381f70_25%,transparent_70%)] white:bg-[linear-gradient(to_left,#243fc7_35%,transparent_80%)] z-200 '>
                  ...
                  <div className='absolute top-20 left-50 text-xs white:text-text'
                    data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="2800" data-aos-offset="-500">

                    <p className='text-2xl mt-2'>5+</p>
                    <p>{t("home.years")}</p>

                    <p className='text-2xl mt-2'>40+</p>
                    <p>{t("home.github")}</p>
