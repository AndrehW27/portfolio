...
function Teste() {
  ...
  useLayoutEffect(() => {
    ...
    return (
      <>
        <section className="relative h-fit w-[100dvw] flex flex-col items-center justify-start overflow-hidden text-text bg-background scroll-hidden pb-50  border-red-500">

          <div className="flex flex-col sm:flex-row items-center items:start justify-center gap-6 sm:gap-10 text-sx sm:text-xl w-[100dvw] mt-20 sm:mt-40 sm:mb-20">
          ...
          {/* CAROUSEL */}
          <div data-aos="fade-left" data-aos-duration="2000" data-aos-offset="10" className=" border-red-500 absolute bottom-5 sm:bottom-10 carousel w-dvw sm:w-310 text-accent white:text-light-blue z-700">
